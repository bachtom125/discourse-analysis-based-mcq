...
def parse_args():
    ...
    parser.add_argument('--inference_dir', help='inference data directory', default='../data/sample/')
...
if __name__ == '__main__':
    ...
    # my tweak so that it only runs inference without evaluation
    if args.inference:
        evaluator = Evaluator(model_dir='./data/model')
        evaluator.eval_parser(path=args.inference_dir, report=False, bcvocab=brown_clusters, draw=False)
